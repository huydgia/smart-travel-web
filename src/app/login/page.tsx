      ...
      <div className="bg-white dark:bg-neutral-900 shadow-xl rounded-xl overflow-hidden w-full max-w-4xl flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 p-8">
          ...
          <div className="space-y-4">
            ...
            />
            <Button className="w-full h-10 bg-blue-600 text-white font-semibold rounded-md hover:bg-blue-700 transition-colors dark:bg-amber-600 dark:hover:bg-amber-700">
              Đăng nhập
            </Button>
            ...
            <div className="flex gap-4 mt-4">
              <Button
                variant="outline"
                className="flex items-center justify-center w-1/2 gap-2 border border-gray-300 rounded-md py-2 hover:bg-gray-100 dark:hover:bg-gray-800 transition"
              >
                <FcGoogle size={20} />
          ...
          <div className="flex justify-start text-sm text-muted-foreground mt-4">
            Chưa có tài khoản?
            <Link href="/signup" className="pl-1 hover:underline">
              Đăng ký
            </Link>
          </div>
        </div>
