...
export const ComboPlanCard = () => {
  ...
  return (
    <section className="bg-white dark:bg-zinc-900 px-4 md:px-10 py-10 space-y-4">
      ...
      <p className="text-gray-600 dark:text-gray-300">Những địa điểm yêu thích theo mùa mà bạn không muốn bỏ lỡ</p>

      <div className="relative">
        <div ref={sliderRef} className="keen-slider">
          {activities.map((item, index) => (
            <div key={index} className="keen-slider__slide bg-white dark:bg-zinc-800 rounded-lg overflow-hidden shadow">
              ...
              <div className="p-3">
                <span className="text-xs px-2 py-1 bg-green-100 text-green-800 rounded-full">{item.location}</span>
